...
import { spirale } from '../../_posts/content/20230222-jak-narysowac-spirale';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{spirale.meta.firstParagraph}</p>
      <spirale.Component />
    </Post>
  );
}
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(spirale.meta.publishTime);
