...
import { zegarBinarny } from '../../_posts/content/20240214-zegar-binarny';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{zegarBinarny.meta.firstParagraph}</p>
      <zegarBinarny.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(zegarBinarny.meta.publishTime);
