...
import { dzienTygodnia } from '../../_posts/content/20210818-okreslanie-dnia-tygodnia-dla-dowolnej-daty';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{dzienTygodnia.meta.firstParagraph}</p>
      <dzienTygodnia.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(dzienTygodnia.meta.publishTime);
