...
import { podstawyLogiki } from '../../_posts/content/20230614-podstawy-logiki';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{podstawyLogiki.meta.firstParagraph}</p>
      <podstawyLogiki.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(podstawyLogiki.meta.publishTime);
