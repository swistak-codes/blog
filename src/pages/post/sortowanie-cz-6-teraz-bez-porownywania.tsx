...
import { sortowanie6 } from '../../_posts/content/20210113-sortowanie-cz-6-teraz-bez-porownywania';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{sortowanie6.meta.firstParagraph}</p>
      <sortowanie6.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(sortowanie6.meta.publishTime);
