...
import { obrazyBMP } from '../../_posts/content/20201028-przetwarzanie-plikow-w-praktyce-obrazy-bmp';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{obrazyBMP.meta.firstParagraph}</p>
      <obrazyBMP.Component />
    </Post>
  );
}
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(obrazyBMP.meta.publishTime);
