...
import { sortowanie4 } from '../../_posts/content/20201217-sortowanie-cz-4-sortowanie-przez-wybieranie';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{sortowanie4.meta.firstParagraph}</p>
      <sortowanie4.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(sortowanie4.meta.publishTime);
