...
import { problemSkoczka } from '../../_posts/content/20221026-problem-skoczka-szachowego';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{problemSkoczka.meta.firstParagraph}</p>
      <problemSkoczka.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(problemSkoczka.meta.publishTime);
