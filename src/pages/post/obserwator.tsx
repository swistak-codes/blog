...
import { obserwator } from '../../_posts/content/20231004-obserwator';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{obserwator.meta.firstParagraph}</p>
      <obserwator.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(obserwator.meta.publishTime);
