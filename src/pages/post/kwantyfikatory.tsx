...
import { kwantyfikatory } from '../../_posts/content/20230705-kwantyfikatory';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{kwantyfikatory.meta.firstParagraph}</p>
      <kwantyfikatory.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(kwantyfikatory.meta.publishTime);
