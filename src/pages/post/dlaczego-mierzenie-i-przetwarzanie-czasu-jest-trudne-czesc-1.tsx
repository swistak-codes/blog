...
import { czasTrudny1 } from '../../_posts/content/20210721-dlaczego-mierzenie-i-przetwarzanie-czasu-jest-trudne-czesc-1';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{czasTrudny1.meta.firstParagraph}</p>
      <czasTrudny1.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(czasTrudny1.meta.publishTime);
