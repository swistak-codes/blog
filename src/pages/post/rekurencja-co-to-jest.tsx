...
import { rekurencja } from '../../_posts/content/20210203-rekurencja-co-to-jest';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{rekurencja.meta.firstParagraph}</p>
      <rekurencja.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(rekurencja.meta.publishTime);
