...
import { zbioryTs } from '../../_posts/content/20230823-teoria-zbiorow-typescript';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{zbioryTs.meta.firstParagraph}</p>
      <zbioryTs.Component />
    </Post>
  );
}
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(zbioryTs.meta.publishTime);
