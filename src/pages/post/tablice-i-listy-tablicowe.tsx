...
import { tabliceListy } from '../../_posts/content/20200508-tablice-i-listy-tablicowe';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{tabliceListy.meta.firstParagraph}</p>
      <tabliceListy.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(tabliceListy.meta.publishTime);
