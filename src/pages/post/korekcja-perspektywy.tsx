...
import { perspektywa } from '../../_posts/content/20250215-korekcja-perspektywy';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{perspektywa.meta.firstParagraph}</p>
      <perspektywa.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(perspektywa.meta.publishTime);
