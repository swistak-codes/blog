...
import { sortowanie2 } from '../../_posts/content/20201202-sortowanie-cz-2-sortowanie-babelkowe';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{sortowanie2.meta.firstParagraph}</p>
      <sortowanie2.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(sortowanie2.meta.publishTime);
