...
import { saper } from '../../_posts/content/20210414-algorytmika-gier-saper';
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(saper.meta.publishTime);
  const modifiedMeta = convertMetadata(saper.meta, prevNextSlugs, similarPosts);
