...
import { sumyKontrolne } from '../../_posts/content/20230308-sumy-kontrolne';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{sumyKontrolne.meta.firstParagraph}</p>
      <sumyKontrolne.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(sumyKontrolne.meta.publishTime);
