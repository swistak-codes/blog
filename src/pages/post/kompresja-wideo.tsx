...
import { kompresjaWideo } from '../../_posts/content/20240619-kompresja-wideo';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{kompresjaWideo.meta.firstParagraph}</p>
      <kompresjaWideo.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(kompresjaWideo.meta.publishTime);
