...
import { losoweId } from '../../_posts/content/20241120-unikalne-identyfikatory';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{losoweId.meta.firstParagraph}</p>
      <losoweId.Component />
    </Post>
  );
}
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(losoweId.meta.publishTime);
