...
import { ackermann } from '../../_posts/content/20231220-funkcja-ackermanna';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{ackermann.meta.firstParagraph}</p>
      <ackermann.Component />
    </Post>
  );
}
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(ackermann.meta.publishTime);
