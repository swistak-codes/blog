...
import { matematyka01 } from '../../_posts/content/20200923-matematyka-zero-jedynkowa';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{matematyka01.meta.firstParagraph}</p>
      <matematyka01.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(matematyka01.meta.publishTime);
