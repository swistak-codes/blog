...
import { onp2 } from '../../_posts/content/20230524-obliczanie-wyrazen-matematycznych';
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(onp2.meta.publishTime);
  const modifiedMeta = convertMetadata(onp2.meta, prevNextSlugs, similarPosts);
