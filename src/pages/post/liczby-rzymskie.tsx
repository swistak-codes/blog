...
import { liczbyRzymskie } from '../../_posts/content/20221116-liczby-rzymskie';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{liczbyRzymskie.meta.firstParagraph}</p>
      <liczbyRzymskie.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(liczbyRzymskie.meta.publishTime);
