...
import { liczbyWymierne } from '../../_posts/content/20201007-liczby-wymierne-i-rzeczywiste-w-zero-jedynkowym-swiecie';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{liczbyWymierne.meta.firstParagraph}</p>
      <liczbyWymierne.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(liczbyWymierne.meta.publishTime);
