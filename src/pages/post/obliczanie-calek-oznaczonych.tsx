...
import { calkiOznaczone } from '../../_posts/content/20211110-obliczanie-calek-oznaczonych';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{calkiOznaczone.meta.firstParagraph}</p>
      <calkiOznaczone.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(calkiOznaczone.meta.publishTime);
