...
import { sortowanie1 } from '../../_posts/content/20201125-sortowanie-cz-1-wprowadzenie-teoretyczne';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{sortowanie1.meta.firstParagraph}</p>
      <sortowanie1.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(sortowanie1.meta.publishTime);
