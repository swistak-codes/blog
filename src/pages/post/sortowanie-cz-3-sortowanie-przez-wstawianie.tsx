...
import { sortowanie3 } from '../../_posts/content/20201208-sortowanie-cz-3-sortowanie-przez-wstawianie';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{sortowanie3.meta.firstParagraph}</p>
      <sortowanie3.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(sortowanie3.meta.publishTime);
