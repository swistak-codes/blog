...
import { listyNZTD } from '../../_posts/content/20200429-listy-najpopularniejsze-zlozone-typy-danych';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{listyNZTD.meta.firstParagraph}</p>
      <listyNZTD.Component />
    </Post>
  );
}
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(listyNZTD.meta.publishTime);
