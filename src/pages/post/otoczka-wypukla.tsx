...
import { otoczkaWypukla } from '../../_posts/content/20231206-otoczka-wypukla';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{otoczkaWypukla.meta.firstParagraph}</p>
      <otoczkaWypukla.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(otoczkaWypukla.meta.publishTime);
