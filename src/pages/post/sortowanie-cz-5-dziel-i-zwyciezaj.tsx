...
import { sortowanie5 } from '../../_posts/content/20210105-sortowanie-cz-5-dziel-i-zwyciezaj';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{sortowanie5.meta.firstParagraph}</p>
      <sortowanie5.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(sortowanie5.meta.publishTime);
