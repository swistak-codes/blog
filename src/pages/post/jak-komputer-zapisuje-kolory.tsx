...
import { kolory } from '../../_posts/content/20211124-jak-komputer-zapisuje-kolory';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{kolory.meta.firstParagraph}</p>
      <kolory.Component />
    </Post>
  );
}
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(kolory.meta.publishTime);
