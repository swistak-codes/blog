...
import { jakRysujeLinie } from '../../_posts/content/20210303-jak-komputer-rysuje-linie';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{jakRysujeLinie.meta.firstParagraph}</p>
      <jakRysujeLinie.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(jakRysujeLinie.meta.publishTime);
