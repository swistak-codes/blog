...
import { symbolNewtona } from '../../_posts/content/20240228-symbol-newtona';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{symbolNewtona.meta.firstParagraph}</p>
      <symbolNewtona.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(symbolNewtona.meta.publishTime);
