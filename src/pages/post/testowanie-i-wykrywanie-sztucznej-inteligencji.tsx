...
import { testowanieSi } from '../../_posts/content/20200702-testowanie-i-wykrywanie-sztucznej-inteligencji';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{testowanieSi.meta.firstParagraph}</p>
      <testowanieSi.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(testowanieSi.meta.publishTime);
