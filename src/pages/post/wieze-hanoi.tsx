...
import { wiezeHanoi } from '../../_posts/content/20210929-wieze-hanoi';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{wiezeHanoi.meta.firstParagraph}</p>
      <wiezeHanoi.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(wiezeHanoi.meta.publishTime);
