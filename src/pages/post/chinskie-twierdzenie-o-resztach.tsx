...
import { crt } from '../../_posts/content/20250122-chinskie-twierdzenie-o-resztach';
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(crt.meta.publishTime);
  const modifiedMeta = convertMetadata(crt.meta, prevNextSlugs, similarPosts);
