...
import { nwd } from '../../_posts/content/20221130-podstawy-algorytmiki-najwiekszy-wspolny-dzielnik';
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(nwd.meta.publishTime);
  const modifiedMeta = convertMetadata(nwd.meta, prevNextSlugs, similarPosts);
