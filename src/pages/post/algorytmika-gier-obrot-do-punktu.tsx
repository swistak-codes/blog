...
import { obrotyGry } from '../../_posts/content/20230322-algorytmika-gier-obrot-do-punktu';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{obrotyGry.meta.firstParagraph}</p>
      <obrotyGry.Component />
    </Post>
  );
}
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(obrotyGry.meta.publishTime);
