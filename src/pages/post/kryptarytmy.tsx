...
import { kryptarytmy } from '../../_posts/content/20211013-kryptarytmy';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{kryptarytmy.meta.firstParagraph}</p>
      <kryptarytmy.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(kryptarytmy.meta.publishTime);
