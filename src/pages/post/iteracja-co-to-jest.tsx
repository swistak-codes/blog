...
import { iteracja } from '../../_posts/content/20221221-iteracja-co-to-jest';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{iteracja.meta.firstParagraph}</p>
      <iteracja.Component />
    </Post>
  );
}
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(iteracja.meta.publishTime);
