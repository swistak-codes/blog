...
import { teoriaZbiorow } from '../../_posts/content/20230719-algebra-zbiorow';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{teoriaZbiorow.meta.firstParagraph}</p>
      <teoriaZbiorow.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(teoriaZbiorow.meta.publishTime);
