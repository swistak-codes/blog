...
import { onp } from '../../_posts/content/20230510-odwrotna-notacja-polska';
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(onp.meta.publishTime);
  const modifiedMeta = convertMetadata(onp.meta, prevNextSlugs, similarPosts);
