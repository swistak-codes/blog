...
import { zegarAnalogowy } from '../../_posts/content/20230208-jak-narysowac-zegar-analogowy';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{zegarAnalogowy.meta.firstParagraph}</p>
      <zegarAnalogowy.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(zegarAnalogowy.meta.publishTime);
