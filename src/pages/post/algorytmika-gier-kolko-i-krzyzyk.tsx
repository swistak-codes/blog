...
import { kolkoKrzyzyk } from '../../_posts/content/20210915-algorytmika-gier-kolko-i-krzyzyk';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{kolkoKrzyzyk.meta.firstParagraph}</p>
      <kolkoKrzyzyk.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(kolkoKrzyzyk.meta.publishTime);
