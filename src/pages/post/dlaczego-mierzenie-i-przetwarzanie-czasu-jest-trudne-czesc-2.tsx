...
import { czasTrudny2 } from '../../_posts/content/20210804-dlaczego-mierzenie-i-przetwarzanie-czasu-jest-trudne-czesc-2';
...
export function Article({
  ...
  return (
    <Post metadata={modifiedMeta} categoryMap={categoryMap} tagsMap={tagsMap}>
      ...
      <p>{czasTrudny2.meta.firstParagraph}</p>
      <czasTrudny2.Component />
    </Post>
  );
}

export const getStaticProps: GetStaticProps<Props> = async () => {
  const dateLink = getDatePathForDate(czasTrudny2.meta.publishTime);
