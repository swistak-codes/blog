    ...
    <>
      ...
      >
        ...
        <ul>
          <li>
            <p>
              <strong>Serwis</strong> - serwis internetowy "świstak.codes"
              działający pod adresem https://swistak.codes
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              firma "MARMOTA SOFTWARE Tomasz Świstak" o nadanym numerze
              identyfikacji podatkowej (NIP): 8943114431, świadcząca usługi
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              <span>lub Serwisy zewnętrzne</span> podczas jednej sesji danego
          ...
          <li>
            <p>
              ...
              <span>lub Serwisy zewnętrzne</span> do momentu ich ręcznego
        ...
        <ul>
          <li>
            <p>
              <strong>Adres pocztowy</strong> - MARMOTA SOFTWARE Tomasz Świstak,
              ul. Górnicza 14/5 54-136 Wrocław
            </p>
          </li>
          <li>
            <p>
              <strong>Adres poczty elektronicznej</strong> -
              tomasz@swistak.codes
            </p>
          </li>
        </ul>
        ...
        <h2>Wypisanie się z analityki</h2>
        <iframe
          style={{ border: '0', height: '200px', width: '600px' }}
          src={`${process.env.NEXT_PUBLIC_MATOMO_URL}/index.php?module=CoreAdminHome&action=optOut&language=pl&backgroundColor=&fontColor=&fontSize=&fontFamily=`}
        ></iframe>
      </Post>
    </>
  );
