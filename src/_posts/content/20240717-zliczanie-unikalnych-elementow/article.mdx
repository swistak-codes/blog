...
W razie czego podrzucam [OnlineGDB](https://onlinegdb.com/OqhbAAg0J) z tym kodem, ale myślę, że nie ma tu zbyt wiele do testowania.
...
Ten kod również znajdziesz na [OnlineGDB](https://onlinegdb.com/WM2XUlTLB).
...
A dla chętnych podrzucam jeszcze [OnlineGDB](https://onlinegdb.com/_11MH_vo7), gdzie taki sam licznik został zrobiony z użyciem [RxJS](https://rxjs.dev/). Przede wszystkim dlatego, że bibliotekę tę często stosuje się do śledzenia napływających danych na front-endzie, co pokazałem w artykule *[Podstawy działania UI — wzorzec obserwator](/post/obserwator)*.
...
Kod, którym wykonałem badanie, znajdziesz na [GitHubie](https://github.com/swistak-codes/snippets-backup/tree/main/hyperloglog-benchmark).
