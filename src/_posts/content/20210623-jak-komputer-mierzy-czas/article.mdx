...
export const meta = {
  ...
  updateTime: '2026-03-15T08:29:16+00:00',
  ...
  coverCaption: (
    <>
      Zdjęcie:
      <br />
      pierwszy plan — Image by <a href="https://pixabay.com/users/buntysmum-5497946/?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=2699338" target="_blank" rel="noreferrer">Beverly Buckley</a> from <a href="https://pixabay.com/?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=2699338" target="_blank" rel="noreferrer">Pixabay</a>
      <br />
      tło — <a href="https://www.flickr.com/photos/befuddledsenses/7265981394" target="_blank" rel="noreferrer">PC Motherboard by Luke Jones</a>, <a href="https://creativecommons.org/licenses/by/2.0/" target="_blank" rel="noreferrer">CC BY 2.0</a>
    </>
  ),
};
...
Jeżeli natomiast chciał(a)byś kiedyś odczytać tę wartość bezpośrednio, to jest to dość proste (w przeciwieństwie do pozostałych liczników). W Assemblerze procesorów x86 otrzymamy ją dzięki instrukcji RDTSC. [Pod tym linkiem](https://onlinegdb.com/0CjqXXbia) znajdziesz kod w języku C, dzięki któremu można odczytać wartość licznika TSC i wypisać ją na ekranie.
...
[W kolejnym artykule opowiemy sobie o przetwarzaniu czasu od strony programowej](/post/jak-komputer-przechowuje-date-i-skad-zna-aktualna). Zarówno jak się go przechowuje i przetwarza, a także jakie konsekwencje niosą ze sobą decyzje projektantów oprogramowania związane z datą i czasem.
