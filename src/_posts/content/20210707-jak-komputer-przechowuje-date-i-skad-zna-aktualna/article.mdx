...
export const meta = {
  ...
  coverCaption: (
    <>
      Zdjęcie: SchiDD, CC BY-SA 4.0 <a href="https://creativecommons.org/licenses/by-sa/4.0" target="_blank" rel="noreferrer">https://creativecommons.org/licenses/by-sa/4.0</a>, via Wikimedia Commons
    </>
  ),
};
