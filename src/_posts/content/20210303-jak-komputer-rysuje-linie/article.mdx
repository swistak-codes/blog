...
export const meta = {
  ...
  coverCaption: (
    <>
      (zdjęcie na okładce: <a href="https://stocksnap.io/author/nathaliejulien" target="_blank" rel="noreferrer">Nathalie E. Julien</a> from <a href="https://stocksnap.io/" target="_blank" rel="noreferrer">StockSnap</a>)
    </>
  ),
};
