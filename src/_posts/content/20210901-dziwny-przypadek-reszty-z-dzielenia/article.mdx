...
export const meta = {
  ...
  updateTime: '2026-03-15T11:07:50+00:00',
  publishTime: '2021-09-01T07:30:19+00:00',
  english: 'https://4markdown.com/the-curious-case-of-division-remainders/',
  cover,
  coverCaption: (
    <>
      (zdjęcie na okładce pochodzi z serwisu <a href="https://www.maxpixel.net/Money-Economy-Finance-Save-Coins-Piggy-Bank-5906402" target="_blank" rel="noreferrer">Max Pixel</a>, udostępnione w domenie publicznej)
    </>
  ),
};
...
W języku Dart wykonujemy poniższy kod źródłowy ([tutaj dostępny w serwisie OnlineGDB](https://onlinegdb.com/eWQafkxG9)):
...
Teraz spróbujemy taki kod w języku Python ([tutaj dostępny w serwisie OnlineGDB](https://onlinegdb.com/wENtkstfb)):
...
Na koniec zobaczmy, jak to wygląda w języku C. W tym języku możemy wyliczać resztę z dzielenia na dwa sposoby, więc tak też zrobimy w przypadku naszego kodu ([tutaj dostępny w serwisie OnlineGDB](https://onlinegdb.com/eBYbz3R_k)):
