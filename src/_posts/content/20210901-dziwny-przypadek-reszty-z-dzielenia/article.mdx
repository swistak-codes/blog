...
export const meta = {
  ...
  coverCaption: (
    <>
      Zdjęcie pochodzi z serwisu <a href="https://www.maxpixel.net/Money-Economy-Finance-Save-Coins-Piggy-Bank-5906402" target="_blank" rel="noreferrer">Max Pixel</a>, udostępnione w domenie publicznej
    </>
  ),
};
