...
Jeśli nie rozumiesz powyższego zapisu z $$\equiv$$ i modulo (czyli arytmetyki modularnej), to omawiałem go w artykule o [szybkim szukaniu dużych liczb pierwszych](/post/szybkie-szukanie-duzych-liczb-pierwszych/#arytmetyka-modularna). Warto nadrobić ten krótki opis, który tam zamieściłem, aby lepiej rozumieć, co dzieje się w tym artykule.
...
Całość wraz z przypadkami testowymi znajdziesz na [OnlineGDB](https://onlinegdb.com/dBWno0Alq).
