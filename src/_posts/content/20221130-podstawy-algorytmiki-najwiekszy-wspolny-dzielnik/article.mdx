...
Działanie możesz przetestować w serwisie [OnlineGDB](https://onlinegdb.com/xJvuiJRvI).
...
Działanie możesz przetestować w serwisie [OnlineGDB](https://onlinegdb.com/nb0dcmIU0).
...
Jak widać powyżej, większość z nich opiera się na mnożeniu lub dzieleniu przez 2, co w systemie binarnym możemy bardzo łatwo zaimplementować za pomocą przesunięć bitowych, co opisałem w artykule *[1 0 0 0? 0 1 0 1! 1 0 0 1 – czyli matematyka zero-jedynkowa](/post/matematyka-zero-jedynkowa)*. Zresztą od tego przystosowania pod system binarny wywodzi się nazwa algorytmu.
...
Działanie możesz przetestować w serwisie [OnlineGDB](https://onlinegdb.com/7KTUJQwub).
...
Działanie możesz przetestować w serwisie [OnlineGDB](https://onlinegdb.com/6Y3MlKfH3). W implementacji oprócz wyżej opisanej optymalizacji związanej z wykorzystaniem przesunięć bitowych zmieniłem też sposób sprawdzania parzystości na sprawdzanie wartości ostatniego bitu (liczby parzyste zawsze mają 0).
