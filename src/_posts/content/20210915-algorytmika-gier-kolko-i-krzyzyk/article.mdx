...
export const meta = {
  ...
  coverCaption: (
    <>
      Ilustracja to kolaż obrazków wygenerowanych przez sieć neuronową VQGAN+CLIP po zadaniu jej różnych kombinacji haseł „animals” oraz „tic-tac-toe”. Źródło obrazka na froncie: <a href="https://commons.wikimedia.org/wiki/File:Tic_tac_toe.svg" target="_blank" rel="noreferrer">https://commons.wikimedia.org/wiki/File:Tic_tac_toe.svg</a>
    </>
  ),
};
