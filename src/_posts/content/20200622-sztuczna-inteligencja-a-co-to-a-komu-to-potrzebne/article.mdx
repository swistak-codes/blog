...
export const meta = {
  ...
  coverCaption: (
    <>
      (oryginał zdjęcia na okładce opublikowany na licencji <a href="https://creativecommons.org/licenses/publicdomain/" target="_blank" rel="noreferrer">CC0</a> w serwisie <a href="https://pixnio.com/pl/obiekty/zabawki/panda-zabawki" target="_blank" rel="noreferrer">Pixnio</a>)
    </>
  ),
