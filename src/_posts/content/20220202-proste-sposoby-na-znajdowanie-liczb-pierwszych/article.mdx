...
export const meta = {
  ...
  coverCaption: (
    <>
      (obrazek na okładce: <a href="https://commons.wikimedia.org/wiki/File:Ammonite_Open_Staircase.jpg" target="_blank" rel="noreferrer">Mike Beauregard from Nunavut, Canada</a>, <a href="https://creativecommons.org/licenses/by/2.0" target="_blank" rel="noreferrer">CC BY 2.0</a>, via Wikimedia Commons)
    </>
  ),
};
