...
Kompletny przykład znajdziesz na [OnlineGDB](https://onlinegdb.com/4akuh3G-0t). Wykonuję tam prosty test, aby sprawdzić, jak nadawanie rankingów działa w praktyce. Warto też tam wejść, żeby pokombinować z wartością `STEP`.
...
Działa to prawidłowo dzięki temu, że [sortujemy leksykograficznie](/post/kryptarytmy/#leksykograficzne-generowanie-permutacji). Mając tablicę `[1, 2, 10, 11, 100]`, w wyniku sortowania leksykograficznego otrzymamy `[1, 10, 100, 11, 2]`. Jest tak dlatego, że cyfry traktujemy jako zwykłe znaki, a nie jako część liczby.
...
Podobnie jak poprzednio, kompletny przykład wraz z testami znajdziesz na [OnlineGDB](https://onlinegdb.com/0dKZu_jiJt).
