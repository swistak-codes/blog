...
export const meta = {
  ...
  coverCaption: (
    <>
      Oryginał zdjęcia: <a href="https://commons.wikimedia.org/wiki/File:UK_search_and_rescue_dogs_in_Nepal_(17298939831.jpg" target="_blank" rel="noreferrer">DFID – UK Department for International Development</a>, CC BY 2.0 <a href="https://creativecommons.org/licenses/by/2.0" target="_blank" rel="noreferrer">https://creativecommons.org/licenses/by/2.0</a>, via Wikimedia Commons)
    </>
  ),
};
