...
export const meta = {
  ...
  coverCaption: (
    <>
      Zdjęcie: Photo by form <a href="https://pxhere.com/en/photo/560162?utm_content=shareClip&utm_medium=referral&utm_source=pxhere" target="_blank" rel="noreferrer">PxHere</a> 
    </>
  ),
};
