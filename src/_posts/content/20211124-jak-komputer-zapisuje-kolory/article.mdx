...
export const meta = {
  ...
  coverCaption: (
    <>
      Zdjęcie: <a href="https://commons.wikimedia.org/wiki/File:%E5%A4%96%E4%BE%86%E5%90%89_Wailaiji_-_panoramio.jpg" target="_blank" rel="noreferrer">lienyuan lee</a>, <a href="https://creativecommons.org/licenses/by/3.0" target="_blank" rel="noreferrer">CC BY 3.0</a>, via Wikimedia Commons
    </>
  ),
};
