...
export const meta = {
  ...
  coverCaption: (
    <>
      (oryginał zdjęcia na okładce pochodzi z serwisu <a href="https://pixabay.com/photos/horse-horse-race-race-animal-3880450/" target="_blank" rel="noreferrer">Pixabay</a>)
    </>
  ),
};
...
- Sortowanie szybkie (quick sort) — powszechnie używany algorytm sortowania bazujący na metodzie „[dziel i zwyciężaj](/post/wyszukiwanie-w-listach)”. Popularny ze względu na wysoką wydajność oraz prostą implementację.
