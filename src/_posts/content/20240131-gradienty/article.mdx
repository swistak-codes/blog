...
Możesz go przetestować, na razie bez rysowania, na [OnlineGDB](https://onlinegdb.com/B-6UhEobK). Przykładowo, dla kolorów białego i czarnego oraz 10 barw dostajemy taką sekwencję:
...
Jeśli czujesz pewien zgrzyt, że korzystamy z estymacji funkcji, a nie z konkretnego wzoru, nie martw się. W informatyce często tak robimy dla ułatwienia obliczeń, na czym zresztą bazuje cała dziedzina obliczeń numerycznych. Podobnie się robi np. przy obliczaniu [całek oznaczonych](/post/obliczanie-calek-oznaczonych) — nie wyliczamy na nie wzoru (choć moglibyśmy), tylko przybliżamy ich wartość, stosując dużo prostsze narzędzia geometryczne.
...
Możesz go przetestować, na razie bez rysowania, na [OnlineGDB](https://onlinegdb.com/50j1-b8UKN). Przykładowo, dla kolorów białego i czarnego, 10 barw oraz punktów $$P_1=(0.33, 1)$$ i $$P_2=(0.68, 1)$$ (szybki wzrost na początku, a potem wolny przyrost) dostajemy taką sekwencję:
