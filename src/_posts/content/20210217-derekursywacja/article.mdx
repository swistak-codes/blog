...
export const meta = {
  ...
  coverCaption: (
    <>
      Zdjęcie: <a href="https://commons.wikimedia.org/wiki/File:Dog_tail_sri-lanka.jpg" target="_blank" rel="noreferrer">Goran tek-en</a>, <a href="https://creativecommons.org/licenses/by-sa/4.0" target="_blank" rel="noreferrer">CC BY-SA 4.0</a>, via Wikimedia Commons
    </>
  ),
};
