...
Kod możesz sprawdzić na platformie [repl.it pod tym linkiem](https://repl.it/@tswistak/iteration-from-tail#main.c). Natomiast porównanie kodu Assemblera dla rekurencji oraz iteracyjnej wersji Fibonacciego, [znajdziesz tutaj](https://godbolt.org/z/9cfrq8).
