...
export const meta = {
  ...
  slug: 'derekursywacja',
  updateTime: '2026-03-15T19:22:40+00:00',
  publishTime: '2021-02-17T10:00:48+00:00',
  cover,
  coverCaption: (
    <>
      (zdjęcie na okładce: <a href="https://commons.wikimedia.org/wiki/File:Dog_tail_sri-lanka.jpg" target="_blank" rel="noreferrer">Goran tek-en</a>, <a href="https://creativecommons.org/licenses/by-sa/4.0" target="_blank" rel="noreferrer">CC BY-SA 4.0</a>, via Wikimedia Commons)
    </>
  ),
};
...
Przełóżmy w dokładnie taki sposób pokazane w poprzednim artykule, ogonowe wersje funkcji Fibonacciego i silni, tym razem tylko w C. Jeżeli nie czytałeś [poprzedniego artykułu](/post/rekurencja-co-to-jest), zachęcam zerknąć do implementacji tam zamieszczonych.
...
Kod możesz sprawdzić na platformie [OnlineGDB pod tym linkiem](https://onlinegdb.com/r6kzr19kn). Natomiast porównanie kodu Assemblera dla rekurencji oraz iteracyjnej wersji Fibonacciego, [znajdziesz tutaj](https://godbolt.org/z/9cfrq8).
...
Jeżeli chcesz przetestować tę funkcję w praktyce, to znajdziesz ją [na serwisie OnlineGDB pod tym linkiem](https://onlinegdb.com/bfXyq3uJN). Dodatkowo znajdziesz tam również zderekursywowaną w analogiczny sposób funkcję Fibonacciego. Aby nie przedłużać niepotrzebnie artykułu, nie zamieszczam jej tutaj, bo zaraz przed nami długa przygoda (i to właśnie z Fibonaccim).
...
Zachęcająco brzmi rekursja ogonowa — ma wydajność zbliżoną do wersji iteracyjnej. Jednak w temacie rekurencji ogonowej, dlaczego ją stosować bądź nie, wypowiedziałem się w [poprzednim artykule o rekurencji](/post/rekurencja-co-to-jest). W skrócie — aby mieć wersję ogonową, i tak dokonujemy w pewnym stopniu derekursywacji, gdyż wersje ogonowe bardzo mocno przypominają tradycyjne iteracyjne, a kompilatory niekoniecznie muszą obsługiwać tę optymalizację.
