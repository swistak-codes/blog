...
export const meta = {
  ...
  coverCaption: (
    <>
      (zdjęcie na okładce: <a href="https://commons.wikimedia.org/wiki/File:CSIRO_ScienceImage_955_Asterias_amurensis_Northern_Pacific_Seastar.jpg" target="_blank" rel="noreferrer">CSIRO</a> / <a href="https://creativecommons.org/licenses/by/3.0" target="_blank" rel="noreferrer">CC BY</a> z modyfikacjami)
    </>
  ),
};
