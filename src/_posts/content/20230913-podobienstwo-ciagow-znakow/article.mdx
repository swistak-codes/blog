...
Możesz go przetestować na [OnlineGDB](https://onlinegdb.com/ev3498uLa). Znajdziesz tam te same przykłady ciągów, które pokazałem dotychczas w tekście.
...
Połączmy wszystko w całość, aby otrzymać [wzór rekurencyjny](/post/rekurencja-co-to-jest) na odległość Levenshteina:
...
Kod znajdziesz na [OnlineGDB](https://onlinegdb.com/fpDSh35l4), gdzie zamieściłem też uruchomienie go dla pokazanych wcześniej przykładów, na czym możesz zweryfikować, czy obliczenia są prawidłowe.
...
Kod możesz przetestować na [OnlineGDB](https://onlinegdb.com/aJg5InOTRe).
