...
Najprostszym sposobem na wyznaczenie pozycji wierzchołków wielokąta foremnego jest opisanie go na okręgu. Wtedy wystarczy okrąg o wybranym promieniu podzielić na $$n$$ równych łuków, gdzie $$n$$ to liczba wierzchołków. Punkty, w których łuki się zaczynają, będą naszymi wierzchołkami. Jednak oczywiście musimy wyznaczyć konkretne położenie punktu w przestrzeni, a nie tylko kąt na okręgu. Coś bardzo analogicznego robiliśmy przy [rysowaniu zegara](/post/jak-narysowac-zegar-analogowy) do rysowania wskazówek czy oznaczenia godzin. Żebyś jednak nie musiał(a) się tam wracać, dam po prostu gotowy wzór:
...
Oto skończyliśmy implementację. Cały kod wraz z możliwością edycji znajdziesz na [CodePen](https://codepen.io/tswistak/pen/YzmmoyG?editors=0010).
...
Możesz go sprawdzić na [CodePen](https://codepen.io/tswistak/pen/ZYzzmXP?editors=0010), a poniżej przetestować w analogiczny sposób jak poprzednią wersję:
...
Jeśli chciałbyś/chciałabyś porysować algorytmicznie nieco więcej, a nie czytałeś(-aś) wcześniej mojego bloga, to podobnie rysowaliśmy [zegar](/post/jak-narysowac-zegar-analogowy), [zegar binarny](/post/zegar-binarny) i [spirale](/post/jak-narysowac-spirale). Do tego eksplorowaliśmy też od strony matematycznej tematy [rysowania roślin](/post/algorytmiczne-rysowanie-roslin) (również [w 3D](/post/algorytmiczne-rysowanie-roslin-w-3d)), [gradientów](/post/gradienty) i [krzywych Béziera](/post/krzywe-beziera).
