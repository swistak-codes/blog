...
export const meta = {
  ...
  coverCaption: (
    <>
      Oryginał zdjęcia autorstwa Oregon State University, opublikowany na licencji <a href="https://creativecommons.org/licenses/by-sa/2.0/" target="_blank" rel="noreferrer">CC BY-SA 2.0</a> w serwisie <a href="https://www.flickr.com/photos/oregonstateuniversity/42628137511" target="_blank" rel="noreferrer">Flickr</a>
    </>
  ),
};
