...
export const meta = {
  ...
  publishTime: '2020-05-08T09:26:54+00:00',
  updateTime: '2026-03-15T10:00:02+00:00',
  cover,
  coverCaption: (
    <>
      (oryginał zdjęcia na okładce autorstwa Oregon State University, opublikowany na licencji <a href="https://creativecommons.org/licenses/by-sa/2.0/" target="_blank" rel="noreferrer">CC BY-SA 2.0</a> w serwisie <a href="https://www.flickr.com/photos/oregonstateuniversity/42628137511" target="_blank" rel="noreferrer">Flickr</a>)
    </>
  ),
};
...
Jeżeli chcecie sami pokombinować, zapraszam do serwisu [OnlineGDB](https://onlinegdb.com/Sq_LZ_pN5). Możecie tam modyfikować kod i uruchamiać go bez potrzeby ściągania kompilatora na komputer.
...
Możemy zauważyć, że w przypadku implementacji tablicy dynamicznej w tym języku, rozmiar z każdą iteracją zwiększa się dwukrotnie. Początkowo, aby nie marnować miejsca, tablica jest pusta, a później zaczynamy od rozmiaru 4. Ponownie zachęcam do własnych eksperymentów z tym kodem na platformie [OnlineGDB](https://onlinegdb.com/Puzycvw8r).

#### C++

Analogicznie sprawa wygląda w C++. [Pod tym linkiem](https://onlinegdb.com/5Dy3zcyOO) znajdziecie kod do programu napisanego w tym języku, robiący dokładnie to samo. Po uruchomieniu możemy zobaczyć, że vector (bo tak nazywa się tablica dynamiczna w C++) również dwukrotnie zwiększa rozmiar. Różnica jest jedynie taka, że ta implementacja nie zaczyna od pojemności 4, lecz 1, po czym zwiększa do 2, a dopiero potem do 4.

#### Java

Sprawdźmy jeszcze, jak sytuacja ma się w Javie, ponieważ tutaj jest nieco inaczej. Kod znajdziecie [pod tym linkiem](https://onlinegdb.com/FOzwUCp-4), jednak nie działa na Javie nowszej niż 9 ze względu na zabezpieczenia. Niestety, w Javie nie było to tak proste jak w C# czy C++, ale nie ma rzeczy niemożliwych. Rezultat wykonania jest następujący:
