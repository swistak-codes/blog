...
export const meta = {
  ...
  coverCaption: (
    <>
      (zdjęcie na okładce: <a href="https://pixabay.com/photos/lotus-flower-white-lily-pad-turtle-2135742/" target="_blank" rel="noreferrer">Image</a> by <a href="https://pixabay.com/users/4753994-4753994/?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=2135742" target="_blank" rel="noreferrer">Rob Slaven</a> from <a href="https://pixabay.com/?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=2135742" target="_blank" rel="noreferrer">Pixabay</a>)
    </>
  ),
};
