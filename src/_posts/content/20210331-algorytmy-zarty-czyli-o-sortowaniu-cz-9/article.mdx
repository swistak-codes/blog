...
export const meta = {
  ...
  coverCaption: (
    <>
      (oryginał zdjęcia na okładce autorstwa <a href="https://www.flickr.com/photos/gcwest/136945654/" target="_blank" rel="noreferrer">Jim Bahn</a>, udostępnione na licencji <a href="https://creativecommons.org/licenses/by/2.0/" target="_blank" rel="noreferrer">CC BY 2.0</a>)
    </>
  ),
};
