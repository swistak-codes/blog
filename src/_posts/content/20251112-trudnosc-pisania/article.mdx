...
export const meta = {
  ...
  updateTime: '2025-11-12T07:00:00+00:00',
...
Zasada ogólnie jest taka, że każdy palce odpowiada za klawisze w swojej kolumnie. Dodatkowo palce wskazujące i małe odpowiadają za kolumny po bokach. Można to zobaczyć na poniższej ilustracji:
...
Możesz go przetestować na [Replit](https://replit.com/@tswistak/manhattan-simple#index.js).
...
Możesz go przetestować na [Replit](https://replit.com/@tswistak/manhattan-fingers#index.js).
...
Możesz go przetestować na [Replit](https://replit.com/@tswistak/typing-effort#index.js).
...
Jak wspomniałem wcześniej, całość implementacji możesz przetestować na [Replit](https://replit.com/@tswistak/carpalx#index.js). Poniżej pokazuję przykładowe wyniki:
