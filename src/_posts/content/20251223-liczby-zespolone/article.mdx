...
export const meta = {
  ...
  cover,
  coverCaption: <>Zdjęcie na okładce wygenerowane przez Canva AI.</>,
};
...
Możesz to sprawdzić na [OnlineGDB](https://onlinegdb.com/-LNxXbpFr).
...
Ten przykład też zamieściłem na [OnlineGDB](https://onlinegdb.com/Yewzhty1N).
...
Jak wcześniej, przykład możesz sprawdzić na [OnlineGDB](https://onlinegdb.com/Bg_9y9FTS).

Z innych języków z wbudowaną obsługą liczb zespolonych warto wspomnieć także o C++ (`std::complex`, [zobacz OnlineGDB](https://onlinegdb.com/xIm8Z9WXW6)), C# (`System.Numerics.Complex`, [zobacz OnlineGDB](https://onlinegdb.com/d1SsK27TL)) i Ruby (`Complex`, [zobacz OnlineGDB](https://onlinegdb.com/_rBRqizLq)). Liczby zespolone obsługują też języki do zastosowań matematycznych i inżynierskich jak [Wolfram Language](https://reference.wolfram.com/language/guide/ComplexNumbers.html), [Julia](https://docs.julialang.org/en/v1/manual/complex-and-rational-numbers/), [Fortran](https://gcc.gnu.org/onlinedocs/gfortran/COMPLEX.html) czy [MATLAB](https://www.mathworks.com/help/matlab/ref/complex.html).
...
Całość możesz przetestować na [OnlineGDB](https://onlinegdb.com/f8NubCucJh).
