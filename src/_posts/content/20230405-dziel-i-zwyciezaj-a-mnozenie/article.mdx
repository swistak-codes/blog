...
Kod możesz przetestować na [OnlineGDB](https://onlinegdb.com/89-55w2zk). Zwrócę tylko uwagę, że pokazany tutaj sposób nie musi być optymalną implementacją, a bardziej chodziło mi o przedstawienie samej idei, jak mnożenie pisemne można zapisać w postaci kodu.
...
Załóżmy, że $$a$$ i $$b$$ możemy przedstawić w postaci $$n$$ cyfr w [systemie pozycyjnym](/post/systemy-liczbowe-uzupelnienie) o podstawie $$B$$ (w systemie dziesiętnym $$B = 10$$). Dla dowolnej dodatniej liczby całkowitej $$m$$ mniejszej od $$n$$ możemy zapisać obie liczby w następujący sposób:
...
Kod znajdziesz na [OnlineGDB](https://onlinegdb.com/duvy5Z3vB). Zamieszczam jeszcze drugą wersję opartą na BigInt [na tym OnlineGDB](https://onlinegdb.com/1F1FSReUo).
