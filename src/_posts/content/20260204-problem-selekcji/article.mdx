...
Wszystkie trzy pokazane powyżej funkcje znajdziesz na [OnlineGDB](https://onlinegdb.com/G6wPDNZcx), gdzie przy okazji dodałem też licznik porównań, abyś mógł/mogła samodzielnie zweryfikować liczbę wykonanych porównań dla różnych rozmiarów tablicy.
...
Całość kodu wraz z testami, licznikiem porównań i możliwością przetestowania na własną rękę znajdziesz na [OnlineGDB](https://onlinegdb.com/57UytY3MN).
...
Następnie wystarczy użyć tej funkcji w miejsce oryginalnego `partition` w `quickselect`. Cały kod znajdziesz na [OnlineGDB](https://onlinegdb.com/H5VD4Nzx4). Są tam takie same testy, jak dla poprzedniej wersji, wraz z porównaniem do niej, abyś mógł/mogła zobaczyć różnicę w wydajności.
