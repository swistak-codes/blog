...
export const meta = {
  ...
  coverCaption: (
    <>
      (oryginał zdjęcia na okładce: <a href="https://www.flickr.com/photos/sometoast/3170625352" target="_blank" rel="noreferrer">Rob Marquardt</a>, udostępnione na licencji <a href="https://creativecommons.org/licenses/by-sa/2.0/" target="_blank" rel="noreferrer">CC BY-SA 2.0</a>)
    </>
  ),
