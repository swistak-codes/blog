...
export const meta = {
  ...
  tags: [],
  slug: 'opensource',
  updateTime: '2026-08-30T07:00:00+00:00',
  publishTime: '2025-04-17T07:00:00+00:00',
  cover,
  coverCaption: <>Zdjęcie wygenerowane z użyciem Midjourney i ChatGPT.</>,
};
...
Teraz dla chętnych opiszę, dlaczego wybrałem takie, a nie inne rozwiązania. Częściowo już to opisałem w *[świstak.codes powraca!](/offtopic/swistak-codes-powraca)*, ale teraz dodam też nieco kontekstu współczesnego.
