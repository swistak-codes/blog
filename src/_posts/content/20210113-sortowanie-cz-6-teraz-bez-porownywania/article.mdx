...
export const meta = {
  ...
  coverCaption: (
    <>
      Oryginał zdjęcia: <a href="https://commons.wikimedia.org/wiki/File:Black-tailed_prairie_dogs_at_SF_Zoo_7.JPG" target="_blank" rel="noreferrer">BrokenSphere</a>, <a href="https://creativecommons.org/licenses/by/3.0" target="_blank" rel="noreferrer">CC BY 3.0</a>, via Wikimedia Commons
    </>
  ),
};
