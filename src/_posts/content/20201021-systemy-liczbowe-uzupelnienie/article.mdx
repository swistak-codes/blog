...
export const meta = {
  ...
  coverCaption: (
    <>
      (oryginał zdjęcia na okładce pobrany z serwisu <a href="https://pixabay.com/photos/paws-cat-claw-paw-claws-feline-340071/" target="_blank" rel="noreferrer">pixabay</a>)
    </>
  ),
};
