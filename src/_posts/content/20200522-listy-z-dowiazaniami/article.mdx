...
export const meta = {
  ...
  coverCaption: (
    <>
      (oryginał zdjęcia na okładce autorstwa <a href="https://www.flickr.com/photos/granth/" target="_blank" rel="noreferrer">Grant Hollingworth</a>, opublikowany na licencji <a href="https://creativecommons.org/licenses/by-sa/2.0/" target="_blank" rel="noreferrer">CC BY-SA 2.0</a> w serwisie <a href="https://www.flickr.com/photos/granth/382907735" target="_blank" rel="noreferrer">Flickr</a>)
    </>
  ),
};
