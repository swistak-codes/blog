...
- Zapis macierzowy i podstawowe operacje na nich. Opisane w *[Macierze — podstawowe operacje](/post/macierze-podstawy)*.
- Obliczanie macierzy odwrotnej. Opisane w *[Macierze — obliczanie wyznacznika](/post/macierze-wyznacznik)*.
- Macierze transformacji w grafice 2D. Opisane w *[Przekształcenia grafiki 2D — matematyczny punkt widzenia](/post/przeksztalcenia-grafiki-2d)*.
...
Sposób obliczania macierzy odwrotnej pokazałem w artykule *[Macierze — obliczanie wyznacznika](/post/macierze-wyznacznik)*. Zróbmy to tutaj krok po kroku.
...
Metodę interpolacji dwuliniowej delikatnie zaznaczyłem w artykule *[Przekształcenia grafiki 2D — matematyczny punkt widzenia](/post/przeksztalcenia-grafiki-2d)*, ale tam podałem jedynie wzory. Tutaj pokażę, jak to zapisać w kodzie.
