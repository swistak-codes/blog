...
Przejdźmy już do renderowania grafiki. W Wolfenstein 3D zastosowanego do tego celu technikę ray castingu (po pol. rzucanie promieni), co z dzisiejszego punktu widzenia jest dość nietypowe. Zobaczmy, o co w tym wszystkim chodzi.
