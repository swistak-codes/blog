...
export const meta = {
  ...
  coverCaption: (
    <>
      Grafika: <a href="https://commons.wikimedia.org/wiki/File:Goats_in_an_argan_tree_Morocco.jpg" target="_blank" rel="noreferrer">Elena Tatiana Chis</a>, <a href="https://creativecommons.org/licenses/by-sa/4.0" target="_blank" rel="noreferrer">CC BY-SA 4.0</a>, via Wikimedia Commons
    </>
  ),
};
