...
export const meta = {
  ...
  updateTime: '2026-03-18T07:00:00+00:00',
...
- Python nie ma typowej [pętli for z licznikiem](/post/iteracja-co-to-jest/#for-jako-pętla-z-licznikiem). W języku tym `for` iteruje po kolekcji, dlatego generujemy listę kolejnych liczb za pomocą funkcji `range()`. Poniżej znajdziesz parę przykładowych odpowiedników pętli z Javy/C++ w Pythonie:
...
Rozwiązanie zadania w całości znajdziesz na [OnlineGDB](https://onlinegdb.com/vGVVGDq81), natomiast poniżej opiszę kolejne podzadania i na co zwrócić uwagę podczas ich rozwiązywania.
...
Kod możesz sprawdzić na [OnlineGDB](https://onlinegdb.com/vGVVGDq81) (plik task1.py).
...
Kod możesz sprawdzić na [OnlineGDB](https://onlinegdb.com/vGVVGDq81) (plik task2.py).
...
Algorytm to najzwyklejsze [wyszukiwanie liniowe](/post/wyszukiwanie-w-listach) po dwuwymiarowej tablicy ze spisywaniem współrzędnych do tablicy za każdym razem, gdy trafimy na szukany znak. Kod jest następujący:
...
Kod w całości możesz sprawdzić na [OnlineGDB](https://onlinegdb.com/vGVVGDq81) (plik task3.py).
...
- *[Dziwny przypadek reszty z dzielenia](/post/dziwny-przypadek-reszty-z-dzielenia)* — obliczanie samego modulo (reszty z dzielenia)
- *[Podstawy algorytmiki: szybkie potęgowanie](/post/szybkie-potegowanie)* — algorytmiczne podejścia do potęgowania
- *[Szybkie szukanie dużych liczb pierwszych](/post/szybkie-szukanie-duzych-liczb-pierwszych/#potęgowanie-modularne)* — algorytm obliczania potęgi modulo
...
Po dodatkowe wyjaśnienia, co tu się dzieje, zapraszam jeszcze raz do *[artykułu o szybkim potęgowaniu](/post/szybkie-potegowanie)*.
...
Rozwiązanie zadania w całości znajdziesz na [OnlineGDB](hhttps://onlinegdb.com/XJN2G-DNQ), natomiast poniżej opiszę kolejne podzadania i na co zwrócić uwagę podczas ich rozwiązywania.

#### Zadanie 3.3

W tym miejscu absolutnie nie ma co się wysilać na napisanie jakiegoś wydajnego algorytmu na sprawdzanie pierwszości liczb. W zupełności wystarczy tak zwana metoda naiwna, którą opisałem w artykule *[Liczby pierwsze i proste sposoby na ich sprawdzanie](/post/liczby-pierwsze-i-proste-sposoby-na-ich-sprawdzanie)*. W skrócie: polega na sprawdzeniu wszystkich liczb naturalnych z przedziału $$(2, \sqrt{n}]$$, gdzie $$n$$ to liczba, której pierwszość sprawdzamy. Jeśli liczba nie była podzielna przez żadną z liczb, oznacza to, że jest pierwsza.
...
Kod możesz sprawdzić na [OnlineGDB](https://onlinegdb.com/XJN2G-DNQ) (plik task3.py).

#### Zadanie 3.4

W tym zadaniu musimy przypomnieć sobie jeszcze inny algorytm — algorytm obliczania największego wspólnego dzielnika. Jest kilka metod na to, co opisałem w artykule *[Podstawy algorytmiki: największy wspólny dzielnik](/post/najwiekszy-wspolny-dzielnik)*. Ja wykorzystam w kodzie algorytm Euklidesa w wersji modulo.
...
Kod znajdziesz także na [OnlineGDB](https://onlinegdb.com/XJN2G-DNQ) (plik task4.py).
...
Kod w całości znajdziesz na [OnlineGDB](https://onlinegdb.com/XJN2G-DNQ) (plik task5.py).
