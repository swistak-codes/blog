...
export const meta = {
  ...
  coverCaption: (
    <>
      (oryginał obrazka na okładce z serwisu <a href="https://pixabay.com/photos/chipmunk-animal-sunflower-seeds-3628624/" target="_blank" rel="noreferrer">Pixabay</a>)
    </>
  ),
};
