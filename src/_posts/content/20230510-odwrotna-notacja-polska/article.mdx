...
- Najpierw [potęgujemy](/post/szybkie-potegowanie) i [pierwiastkujemy](/post/pierwiastkowanie).
- Następnie [mnożymy](/post/dziel-i-zwyciezaj-a-mnozenie) i dzielimy.
...
Obecne tutaj nawiasy nie mają takiej funkcji jak w matematyce w zapisie infiksowym. Nawiasy wyznaczają listy, ponieważ jest to podstawowa struktura danych w Lisp i wszystko w nim jest listą. Kod w praktyce możesz sprawdzić na [Wandbox](https://wandbox.org/permlink/rEkIODPih4R1Wyd8).
...
Kod możesz przetestować na [OnlineGDB](https://onlinegdb.com/Ax_GA5ewN). Możesz go też przetestować poniżej. Wpisz działanie i zobacz, jak krok po kroku oblicza się jego wynik.
