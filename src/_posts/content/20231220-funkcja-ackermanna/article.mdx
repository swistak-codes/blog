...
export const meta = {
  ...
  updateTime: '2026-03-17T21:37:00+00:00',
  publishTime: '2023-12-20T07:00:00+00:00',
  cover,
  coverCaption: <>Zdjęcie na okładce oraz mem na końcu wygenerowane przez DALL-E.</>,
};
...
Najbardziej intuicyjną dla informatyków definicją, jaką moglibyśmy podać, jest taka, że jeśli zaprogramujemy taką funkcję, to kod będzie się składać jedynie z [pętli z licznikiem](/post/iteracja-co-to-jest) (`for`), gdzie liczbę iteracji znamy jeszcze przed ich rozpoczęciem.
...
Kod zamieszczam również na [OnlineGDB](https://onlinegdb.com/QLepHWGbQ), gdzie możesz sprawdzić też szybkość działania. U mnie obliczanie $$A(4,1)$$ zajęło ponad 18 sekund. Przełożenie na kod asemblerowy przykładowych konfiguracji poziomów optymalizacji (kompilator clang 17.0.1 dla architektury x86-64) możesz znaleźć na [Compiler Explorer](https://godbolt.org/z/fcPf14aGn).
...
// możesz je zobaczyć w całości kodu na OnlineGDB
int a(int m, int n) {
...
Tak samo jak poprzednio, kod wykonywalny wraz z mierzeniem czasu wykonania znajdziesz na [OnlineGDB](https://onlinegdb.com/i9gsH9Nl5). Tym razem nie zamieszczam wersji skompilowanych do asemblera — chętnych zapraszam do samodzielnego zrobienia tego, np. na platformie [Compiler Explorer](https://godbolt.org/), tak jak ja to robiłem.
...
Ponownie, kod w wersji wykonywalnej znajdziesz na [OnlineGDB](https://onlinegdb.com/PJNOgPuJZ).
