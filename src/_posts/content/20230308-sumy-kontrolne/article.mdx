...
Możesz go przetestować na [OnlineGDB](https://onlinegdb.com/8_cgC8b-_).
...
3. Cyfrę kontrolną obliczamy jako [resztę z dzielenia](/post/dziwny-przypadek-reszty-z-dzielenia) powyższej sumy przez 11 (modulo 11).
...
Możesz go przetestować na [OnlineGDB](https://onlinegdb.com/6FH8JplMi).
...
Dlaczego więc 11? Jest to liczba pierwsza i liczenie reszty jest odporne na takie przypadki. Możesz zobaczyć na [tym OnlineGDB](https://onlinegdb.com/ATCM2XXoT), że dla NIP-u (bez cyfry kontrolnej) 123456321 i 123456371 (zmiana przedostatniej cyfry) dostalibyśmy taką samą cyfrę kontrolną przy modulo 10 (8), natomiast przy modulo 11 różne cyfry (8 i 5).
...
Możesz go przetestować na [OnlineGDB](https://onlinegdb.com/whcKqOw1F).
...
Możesz ją przetestować na [OnlineGDB](https://onlinegdb.com/1OSRDFg--c).
...
Pierwsze podejście może nasunąć skojarzenie z [sortowaniem przez scalanie](/post/sortowanie-cz-5-dziel-i-zwyciezaj), gdzie rekurencyjnie dzielimy kolejne dane na pół. Tutaj robimy coś podobnego, ale wykonując po drodze obliczenia, aby ostatecznie otrzymać jeden bit. Wygląda to następująco:
...
Powyższy kod możesz przetestować na [OnlineGDB](https://onlinegdb.com/VxZ-7YsOO).
...
Możesz go przetestować na [OnlineGDB](https://onlinegdb.com/5XHITDTwd).
