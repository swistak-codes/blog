...
Na samym początku chciałem wspomnieć, że temat ten jest bardzo powiązany z tematem kompresji obrazów, który poruszyłem w artykule (uwaga, nikt się nie spodziewa tego tytułu) *[Kompresja obrazów](/post/kompresja-obrazow)*. Omówionych tam technik, algorytmów i zagadnień nie będę tutaj powtarzać.
