...
export const meta = {
  ...
  coverCaption: (
    <>
      (zdjęcie na okładce: <a href="https://commons.wikimedia.org/wiki/File:Tiktaalik_roseae_life_restor.jpg" target="_blank" rel="noreferrer">Zina Deretsky, National Science Foundation (Courtesy: National Science Foundation)</a>, Public domain, via Wikimedia Commons)
    </>
  ),
};
