...
export const meta = {
  ...
  coverCaption: (
    <>
      (na okładce wykorzystano następujące obrazki z domeny publicznej: <a href="https://commons.wikimedia.org/wiki/File:Sudoku_Puzzle_by_L2G-20050714_standardized_layout.svg" target="_blank" rel="noreferrer">1</a>, <a href="https://freesvg.org/snake-number-one-vector-clip-art" target="_blank" rel="noreferrer">2</a>, <a href="https://freesvg.org/two-1574111248" target="_blank" rel="noreferrer">3</a>)
    </>
  ),
};
