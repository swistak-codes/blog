...
export const meta = {
  ...
  coverCaption: (
    <>
      (zdjęcie na okładce: <a href="https://commons.wikimedia.org/wiki/File:Honey_badger,_Mellivora_capensis,_carrying_young_pup_in_her_mouth_at_Kgalagadi_Transfrontier_Park,_Northern_Cape,_South_Africa_(34484155600).jpg" target="_blank" rel="noreferrer">Derek Keats from Johannesburg, South Africa</a>, <a href="https://creativecommons.org/licenses/by/2.0" target="_blank" rel="noreferrer">CC BY 2.0</a>, via Wikimedia Commons)
    </>
  ),
};
