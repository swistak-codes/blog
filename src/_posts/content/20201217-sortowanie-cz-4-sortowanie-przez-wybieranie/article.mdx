...
export const meta = {
  ...
  coverCaption: (
    <>
      (zdjęcie na okładce z serwisu <a href="https://pxhere.com/en/photo/1359582" target="_blank" rel="noreferrer">pxhere</a>)
    </>
  ),
};
