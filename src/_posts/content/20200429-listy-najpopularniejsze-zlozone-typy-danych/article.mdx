...
export const meta = {
  ...
  coverCaption: (
    <>
      Oryginał zdjęcia opublikowany w serwisie <a href="https://pixnio.com/fauna-animals/sheeps/herd-merino-sheep-cattle-livestock-animal-agriculture" target="_blank" rel="noreferrer">Pixnio</a> na licencji CC0
    </>
  ),
};
