...
export const meta = {
  ...
  coverCaption: (
    <>
      Oryginał zdjęcia opublikowany w serwisie <a href="https://pixabay.com/photos/bison-animals-buffalo-wild-horns-4861278/" target="_blank" rel="noreferrer">Pixabay</a>
    </>
  ),
};
