...
export const meta = {
  ...
  coverCaption: (
    <>
      (zdjęcie na okładce pochodzi z serwisu <a href="https://pixabay.com/pt/photos/rel%C3%B3gio-decora%C3%A7%C3%A3o-escultura-3572705/" target="_blank" rel="noreferrer">Pixabay</a>)
    </>
  ),
};
...
A jeśli lubisz takie ciekawostki, [to zapraszam do części drugiej](/post/dlaczego-mierzenie-i-przetwarzanie-czasu-jest-trudne-czesc-2).
