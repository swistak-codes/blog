...
export const meta = {
  ...
  coverCaption: (
    <>
      Zdjęcie pochodzi z serwisu <a href="https://pixabay.com/pt/photos/rel%C3%B3gio-decora%C3%A7%C3%A3o-escultura-3572705/" target="_blank" rel="noreferrer">Pixabay</a>
    </>
  ),
};
