...
export const meta = {
  ...
  slug: 'kryptarytmy',
  updateTime: '2026-03-15T08:37:24+00:00',
  publishTime: '2021-10-13T07:30:01+00:00',
  cover,
  coverCaption: (
    <>
      (okładka autorstwa własnego, z wykorzystaniem czcionki <a href="https://openmoji.org/" target="_blank" rel="noreferrer">OpenMoji</a>)
    </>
  ),
};
...
W tym miejscu pokażę dwa algorytmy, które możemy wykorzystać do wygenerowania wszystkich permutacji. Do każdego z nich zamieściłem przykład w kodzie, dostępny na platformie OnlineGDB, gdzie możesz przetestować jego działanie. Oprócz tego kod wszystkich znajdziesz na moim [GitHubie](https://github.com/swistak-codes/alphametics). Wszystkie kody źródłowe zostały napisane w JavaScript (Node).
...
Przełożenie algorytmu na kod znajdziesz [tutaj](https://github.com/swistak-codes/alphametics/blob/main/algorithms/lexicographic.js), natomiast przykład rozwiązywania kryptarytmów tym sposobem [w tym miejscu](https://onlinegdb.com/MxsUDNUpG).
...
Przełożenie algorytmu na kod znajdziesz [tutaj](https://github.com/swistak-codes/alphametics/blob/main/algorithms/plainChanges.js), natomiast przykład rozwiązywania kryptarytmów tym sposobem [w tym miejscu](https://onlinegdb.com/6ejlmLXpj).
