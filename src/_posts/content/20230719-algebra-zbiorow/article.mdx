...
export const meta = {
  ...
  updateTime: '2026-03-16T23:00:00+00:00',
...
Tekst jest kontynuacją artykułów *[Logika dla informatyków — podstawy](/post/podstawy-logiki)* i *[Logika dla informatyków — kwantyfikatory](/post/kwantyfikatory)*. Dlatego też zakładam, że pojęcia, które tam przedstawiłem, nie są Ci obce.
...
Przykład na zbiorach w Pythonie (kod dostępny na [OnlineGDB](https://onlinegdb.com/3ie0Huo5e)):
...
A tutaj analogiczna operacja na tablicach w JavaScript z Lodashem (kod dostępny na [OnlineGDB](https://onlinegdb.com/EMvrNt_gS)):
...
Obie funkcje możesz przetestować na [OnlineGDB](https://onlinegdb.com/tqRKyq3Le).
...
Przykład na zbiorach w Pythonie (kod dostępny na [OnlineGDB](https://onlinegdb.com/PdRsJt_pJN)):
...
Analogiczna operacja na tablicach w JavaScript z Lodashem (kod dostępny na [OnlineGDB](https://onlinegdb.com/f8olPx7Ia)):
...
Funkcję możesz przetestować na [OnlineGDB](https://onlinegdb.com/aGjvNK3io).
...
Jak sprawa ma się w programowaniu? Tutaj mimo angielskiej nazwy *complement* różnicę zbiorów zwykle znajdziemy jako funkcję `difference()`, czyli w dosłownym tłumaczeniu *różnica*. A skoro różnica, to np. w Pythonie możemy zastosować operator odejmowania (czyli po prostu `-`) do wykonania tej operacji. Zobacz przykład w Pythonie (dostępny na [OnlineGDB](https://onlinegdb.com/TTK17sgRK)):
...
Poniżej jeszcze przykład na tablicach w JavaScript z Lodashem (również dostępny na [OnlineGDB](https://onlinegdb.com/DfvpozZLz)):
...
Kod jak zawsze możesz przetestować na [OnlineGDB](https://onlinegdb.com/M04UQD8fw).
...
W programowaniu znowu możemy się odwołać do angielskiej nazwy tej operacji — np. w Pythonie znajdziemy ją jako `symmetric_difference()` lub pod operatorem `^` (operator alternatywy rozłącznej). Poniżej przykład w kodzie (dostępny na [OnlineGDB](https://onlinegdb.com/Q30ecHMdz)):
...
Natomiast w JavaScript z Lodashem znajdziemy funkcję `xor()`, wykonującą dokładnie to samo. Poniżej przykład w kodzie (dostępny na [OnlineGDB](https://onlinegdb.com/nC7IOgF8T)):
...
Kod jak zawsze znajdziesz na [OnlineGDB](https://onlinegdb.com/T_bFL-xAp).
...
Z racji tego, że zawsze pokazywałem też Pythona, to i tutaj go pokażę. W tym języku może nie ma iloczynu kartezjańskiego, ale korzystając z wbudowanej składni pisania iteracji, możemy zawrzeć tę operację w jednej linijce kodu (kod dostępny na [OnlineGDB](https://onlinegdb.com/hxnX0qr4c)):
...
Jak zawsze kod jest dostępny na [OnlineGDB](https://onlinegdb.com/YTkwRIp_U).
