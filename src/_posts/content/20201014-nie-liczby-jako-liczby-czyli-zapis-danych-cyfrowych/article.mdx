...
export const meta = {
  ...
  coverCaption: (
    <>
      Zdjęcie: <a href="https://imaggeo.egu.eu/view/14530/" target="_blank" rel="noreferrer">Kelvin, Tsz Hei Choi (distributed via imaggeo.egu.eu </a>/ <a href="https://creativecommons.org/licenses/by-sa/3.0/" target="_blank" rel="noreferrer">CC BY-SA 3.0</a>)
    </>
  ),
};
