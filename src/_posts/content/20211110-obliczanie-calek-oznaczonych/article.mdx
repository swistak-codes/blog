...
export const meta = {
  ...
  coverCaption: (
    <>
      (wąż na okładce pochodzi ze strony <a href="https://publicdomainvectors.org/en/free-clipart/Green-and-brown-color-snake-line-art-vector-illustration/24570.html" target="_blank" rel="noreferrer">publicdomainvectors</a>)
    </>
  ),
};
