...
export const meta = {
  ...
  keyword: '',
  slug: 'licencje',
  updateTime: '2026-03-19T18:04:35+00:00',
...
Tyczy się to także grafik wygenerowanych automatycznie przez AI (oznaczone, jako generowane przez DALL-E lub inne narzędzia). Grafika na tej stronie również została wygenerowana z użyciem DALL-E.
...
Kody źródłowe przedstawione na stronie oraz zalinkowane na GitHubie, OnlineGDB oraz innych platformach tego typu, są na licencji MIT, chyba że napisano inaczej.
